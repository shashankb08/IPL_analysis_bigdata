...
if __name__ == "__main__":
    ...
    data = sc.textFile("/home/bsnova/Desktop/assignment/bowl11.csv")
    ...
    for i in range(0,cluster_no):
        clusters.append([])
    with open('/home/bsnova/Desktop/assignment/bowl1.csv') as csv_file:
	if csv_file :
		print ("1")
    ...
    csv_file.close()
    with open('/home/bsnova/Desktop/assignment/bowlc.csv', 'w') as File:
	if File :
		print("2")        
